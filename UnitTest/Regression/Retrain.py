...
options = DashOptions(
    [
        ...
        ('batchSize',      'The batch size used in each iteration of training..(Default: 32)',  ['int', 'min:10', 'default:64']),
...
if __name__ == '__main__':
    ...
    if options.get('paramSearch'):
        ...
        parameterChoices = [
                            ...
                            ('dropOut',      [0]),
                            ('batchSize',    [32, 64]),
                            ('learningRate', ["(0.0001,0.00001)", "[(0,0.0001),(500,0.00001),(1500,0.000001)]"]),
                            ('optimizer',    ['Adam']),
                            ('epochs',       [5]),
                           ]
