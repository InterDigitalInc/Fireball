...
if __name__ == '__main__':
    ...
    model.exportToCoreMl(options.get('out'), labels=EvenOddDSet.classNames, rgbBias=-.5, scale=1.0/255)
    ...
    myPrint('\nPreparing Even/Odd dataset ... ', False)
...
#        img.show()
        ...
        prob = list(output_dict["classProbs"].values())[0]
        predictions += [ np.int32(np.round(prob)) ]
