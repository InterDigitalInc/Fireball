...
options = DashOptions(
    [
        ...
        ('learningRate',   'Can be one of the following:(Default: 0.0001,0.00001)\n'+
                           'lrValue: Fixed learning rate during the training.\n'+
                           '"(start, end)": learning rate starts at "start" ending in "end".\n'+
                           '"[(1,lr1),(N2,lr2),...,(nN,lrN)]" Piecewise learning rate.',        ['string', 'default:(0.0001,0.00001)']),
...
if __name__ == '__main__':
    ...
    if options.get('paramSearch'):
        ...
        parameterChoices = [
                            ...
                            ('dropOut',      [0.2, 0.1]),
                            ('batchSize',    [128, 64]),
                            ('learningRate', ["(0.001,0.00001)", "[(1,.0001),(2,.001),(7,.00001)]"]),
                            ('optimizer',    ['Momentum']),
                            ('epochs',       [10]),
                           ]
